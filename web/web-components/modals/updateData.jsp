  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="updateModal">Zaktualizuj dane</h5>
      ...
      <div class="modal-body">
        <form id="updateForm" method="post" action="/UpdateData">
          <div class="form-group">
            ...
            <input type="text" class="form-control" distabled id="id" name="id">
          </div>
          <div class="form-group">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-primary" onclick="event.preventDefault();document.getElementById('updateForm').submit();">Zaktualizuj</button>
